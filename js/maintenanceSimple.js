...
const detailsInstallationInput = document.querySelector('#detailsInstallationInput');
...
const deplacementSuppPriceContainer = document.querySelector('.deplacementSuppPriceContainer');
const optionSuppInput = document.querySelector('#optionSuppInput');
const optionSuppPriceContainer = document.querySelector('.optionSuppPriceContainer');
...
const pdf_Details_Installation_Input = document.querySelector('#pdf_Details_Installation_Input');
...
const pdf_Date_Installation_Input = document.querySelector('#pdf_Date_Installation_Input');
const pdf_Visites_Input = document.querySelector('#pdf_Visites_Input');
// Inputs PDF ARRAY
const pdf_Prix_Systeme_Input = document.querySelector('#pdf_Prix_Systeme_Input');
const pdf_Prix_Deplacementsupp_Input = document.querySelector('#pdf_Prix_Deplacementsupp_Input');
const pdf_Prix_Optionsupp_Input = document.querySelector('#pdf_Prix_Optionsupp_Input');

const pdf_Deplacementsupp_Input = document.querySelector('#pdf_Deplacementsupp_Input');
...
const pdf_Date_Contrat_Input = document.querySelector('#pdf_Date_Contrat_Input');
...
const maintenancePriceTab = [
    123.21, 156.42, 177.85, 211.06, 177.85, 156.42, 200.35, 84.64, 123.21, 177.85, 211.06, 237.85
];
...
const optionSuppTab = [
    "",
    "Option Piscine sur PAC",
    "Option PAC > à 25 Kw",
    
]
// Tableau prix options supplémentaires simple
const optionSuppPriceTab = [
    0, 49.33, 43.92
]
...
function pushFormInformations () {
    generateBtn.addEventListener('click', () => {
        ...
        pdf_Prix_Deplacementsupp_Input.innerText = deplacementSuppPriceContainer.innerText;
...
function calculatePricesInPdf () {
    generateBtn.addEventListener('click', () => {
        ...
        let deplacement = parseFloat(pdf_Prix_Deplacementsupp_Input.innerText.replace('€', ''));
        let option = parseFloat(pdf_Prix_Optionsupp_Input.innerText.replace('€', ''));
